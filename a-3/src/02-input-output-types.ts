...
console.log(fixValue3(1 / 2) === '0.5')

// returns default if 2 digits
console.log(fixValue3(1 / 4) === '0.25')

// returns default if 3 digits
console.log(fixValue3(7 / 8) === '0.875')

// returns toFixed if 4 digits
console.log(fixValue3(13 / 16) === '0.813') // 0.8125

// returns toFixed if more digits
console.log(fixValue3(29 / 63) === '0.460') // 0.4603174603174603

// returns toFixed for PI
console.log(fixValue3(Math.PI) === '3.142') // 3.141592653589793
