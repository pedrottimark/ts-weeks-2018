import createElement from './00-createElement.ts'
import { Item, deleteItem, getDoer, getItems, patchItem, postItem } from './06-fetch.ts'
import renderAdder from './07-renderAdder.ts'
import renderItem from './07-renderItem.ts'
import './08-index.css'
